...
export const PostPasswordChange = createAsyncThunk('auth/PostPasswordChange', async (passwordChanege, { rejectWithValue }) => {
    try {
        // axios.defaults.headers.post['Authorization'] = "Bearer " + token
        const postPasswordChangeRespose = await axios.post('http://api.a2zscore.com/admin-new-apis/enduser/change-password', passwordChanege);
...
export const PostGetStackApi = createAsyncThunk('auth/PostGetStackApi', async (id, { rejectWithValue }) => {
    try {
        // axios.defaults.headers.post['Authorization'] = "Bearer " + sportsId
        const PostGetStackData = await axios.post("http://api.a2zscore.com/admin-new-apis/enduser/get-stake-button");
...
export const PostEditStack = createAsyncThunk('auth/PostEditStack', async (data, { rejectWithValue }) => {
    try {
        const PostEditStackData = await axios.post("http://api.a2zscore.com/admin-new-apis/enduser/set-stake-button", data);
...
export const PostBetListByMatchId = createAsyncThunk('auth/PostBetListByMatchId', async (data, { rejectWithValue }) => {
    try {
        ...
        // axios.defaults.headers.post['Authorization'] = "Bearer "+token
        const BetListByMatchId = await axios.post("http://api.a2zscore.com/admin-new-apis/enduser/bet-list-by-matchid", data);
...
export const PostTransferStatement = createAsyncThunk('auth/TransferStatement', async (data, { rejectWithValue }) => {
    try {
        // axios.defaults.headers.post['Authorization'] = "Bearer "+token
        const TransferStatementData = await axios.post("http://api.a2zscore.com/admin-new-apis/enduser/account-statement", data);
...
export const PostPlaceBet = createAsyncThunk('auth/PostPlaceBet', async (data, { rejectWithValue }) => {
    try {
        const PlaceBet = await axios.post("http://api.a2zscore.com/admin-new-apis/enduser/place-bets", data);
        return PlaceBet
    } catch (err) {
        if (err) {
            throw err
...
export const Postactivematchsport = createAsyncThunk('auth/Postactivematchsport', async (data, { rejectWithValue }) => {
    try {
        const PlaceActivematchsport = await axios.post("http://api.a2zscore.com/admin-new-apis/enduser/active-match-sport-wise-open", data);
...
export const PostBalance = createAsyncThunk('auth/PostBalance', async (data, { rejectWithValue }) => {
    try {
        const getBalance = await axios.post("http://api.a2zscore.com/admin-new-apis/enduser/get-user-balance", data);
        return getBalance
    } catch (err) {
        if (err) {
            throw err
