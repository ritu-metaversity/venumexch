    ...
    <>
      ...
      <li>
        <div
          ...
          onClick={() => handleMyMarket()}>
          <div className="item">
            <i className="fas fa-eye"></i>{" "}
            <span className="menu-name">My Markets</span>
          </div>
        </div>
      </li>
      {postleftmenudataopenData?.data && postleftmenudataopenData?.data
        ? postleftmenudataopenData?.data.map((item) => (
            <li>
              <div
                onClick={() => handleRoute(item?.sportId, item?.sportName)}
                style={{ cursor: "pointer" }}
                className="favourites-a">
                <div className="menu-lvl-1">
                  <div className="item">
                    {item?.sportId === 77 ? (
                      ...
                      <img
                        src={`https://d1arlbwbznybm5.cloudfront.net/v1/static/mobile/images/gicons/${
                          item?.sportId === 14 ? 52 : item?.sportId
                        }.png`}
                        alt=""
                        className="game-icon"
                      />
                    )}
                    <span className="menu-name">{item?.sportName}</span>
                  </div>
                </div>
              </div>
            </li>
        ...
        <>
          <li>
            <Link to="/m/International-home" className="">
              <div
                className="menu-lvl-1"
                onClick={() => props.eftMenuClose(false)()}>
                <div className="item">
                  <img
                    alt=""
                    src="/Casino-Logo/international-casinoletest.png"
                    className="game-icon"
                  />{" "}
                  <span className="menu-name download-apk">
            ...
            <Link to="/m/Lottery-home" className="">
              <div
                ...
                <div className="item">
                  <img
                    alt=""
                    src="/Casino-Logo/lottery.png"
                    className="game-icon"
                  />{" "}
                  <span className="menu-name download-apk"> Lottery</span>
                </div>
              </div>
            </Link>
          </li>
            ...
            <Link to="/m/Slot-home" className="">
              <div
                ...
                <div className="item">
                  <img
                    alt=""
                    src="/Casino-Logo/slots.png"
                    className="game-icon"
                  />{" "}
                  <span className="menu-name download-apk">Slots Games</span>
                </div>
              </div>
            </Link>
          </li>
            ...
            <Link to="/m/Fantasy-home" className="">
              <div
                ...
                <div className="item">
                  <img
                    alt=""
                    src="/Casino-Logo/fantasy-game.png"
                    className="game-icon"
                  />{" "}
                  <span className="menu-name download-apk">Fantasy Games</span>
                </div>
              </div>
            </Link>
          </li>
