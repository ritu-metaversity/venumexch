...
const BettingProfitLoss = () => {
  ...
  const handleSelectGame = (e) => {
    ...
    axios
      .post(
        "https://adminapi.foldexch.com/admin-new-apis/enduser/active-match-sport-wise-open",
        { sportId: inputValue }
      )
      .then((res) => {
  ...
  useEffect(() => {
    ...
    axios
      .post(
        "https://adminapi.foldexch.com/admin-new-apis/casino/casino-tables-by-types",
        id
      )
      .then((res) => {
