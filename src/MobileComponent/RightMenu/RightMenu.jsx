...
{PostTotalBalance?.data?.data?.winnings>0?
                  <span   className="negative" style={{color:"green"}}>{PostTotalBalance?.data?.data?.winnings ? PostTotalBalance?.data?.data?.winnings: "0:00"}</span>
         ...
         <li>
            {/* <Link href="/m/transfer-statement"   className=""> */}
               <div   className="menu-lvl-1" onClick={()=>handleInput("TransferStatement")}>
                  <div   className="item"><img alt="" src="https://d1arlbwbznybm5.cloudfront.net/v1/static/mobile/images/icons/transfer-statement.png"/> <span   className="menu-name">Account Statement</span></div>
               </div>
            {/* </Link> */}
         </li>
         {/* <li>
