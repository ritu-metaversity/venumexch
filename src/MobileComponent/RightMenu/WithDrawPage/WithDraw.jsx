  ...
  const handleInput = (e) => {
    ...
    switch (inputName) {
      case "Amount":
        ...
        setAmountError(ValidationFile.isEmpty(ValidationFile.spaceNotAccept(inputValue)));
        break;
      case "AccountNumber":
        setAccountNumber(ValidationFile.spaceNotAccept(inputValue));
        setAccountNumberError(ValidationFile.isEmpty(ValidationFile.spaceNotAccept(inputValue)));
        break;
      case "AccountName":
        setAccountHolderName(ValidationFile.spaceNotAccept(inputValue));
        setAccountHolderNameError(ValidationFile.isEmpty(ValidationFile.spaceNotAccept(inputValue)));
        break;
      case "BankName":
        setBankName(ValidationFile.spaceNotAccept(inputValue));
        setBankNameError(ValidationFile.isEmpty(ValidationFile.spaceNotAccept(inputValue)));
        break;
      case "IFSC":
        setIfsc(ValidationFile.spaceNotAccept(inputValue));
        setIfscError(ValidationFile.isEmpty(ValidationFile.spaceNotAccept(inputValue)));
        break;
      default:
        return false;
    }
