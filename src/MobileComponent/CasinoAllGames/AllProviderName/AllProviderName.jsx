...
import {
  postFindProviderList,
  psotbetsingleusevalue,
...
const AllProviderName = () => {
  ...
  const handleGamePageInternatinola = (item) => {
    if (psotbetsingleusevalueData?.data?.qtech === 1) {
      navigate("/m/All-Games-page", {
        state: {
          item1: { gameCode: item?.providerId },
          item2: window.location.pathname,
        },
      });
      setShow(false);
      ...
      {token ? (
        <>
          {gameAura?.active === true
            ? Object.keys(IndianCasinoLive).map((key, item) => (
                <div className="Inner_header_for_game_provide_Incasin">
                  ...
                  <div className="main_wrap_live-casion">
                    {IndianCasinoLive &&
                      IndianCasinoLive[key].map((item, index) => (
                        <div
                          className="MainBtn_warp"
                          style={{ border: "0.5px solid" }}
                          onClick={() => handleGamePageroute(item)}>
                          <img
          ...
          {gameQtech?.active === true ? (
            <>
              <div className="Inner_header_for_game_provide_Incasin">
                <h3 className="provider_name_details">International Casino</h3>
                <div className="main_wrap_live-casion">
                  {casionProviderData &&
                    casionProviderData?.data &&
                    casionProviderData?.data.liveCasino.map((item, index) => (
                      <div
                        className="MainBtn_warp"
                        style={{ border: "0.5px solid" }}
                        onClick={() => handleGamePageInternatinola(item)}>
                        <img
                          className="complany-logo-warp"
                          src={item?.image}
                          alt=""
              ...
              <div className="Inner_header_for_game_provide_Incasin">
                <h3 className="provider_name_details">Lottery</h3>
                <div className="main_wrap_live-casion">
                  {casionProviderData &&
                    casionProviderData?.data &&
                    casionProviderData?.data.lottery.map((item, index) => (
                      <div
                        className="MainBtn_warp"
                        style={{ border: "0.5px solid" }}
                        onClick={() => handleGamePageLottery(item)}>
                        <img
                          className="complany-logo-warp"
                          src={item?.image}
                          alt=""
              ...
              <div className="Inner_header_for_game_provide_Incasin">
                <h3 className="provider_name_details">Slot</h3>
                <div className="main_wrap_live-casion">
                  {casionProviderData &&
                    casionProviderData?.data &&
                    casionProviderData?.data.slot.map((item, index) => (
                      <div
                        className="MainBtn_warp"
                        style={{ border: "0.5px solid" }}
                        onClick={() => handleGamePageSlot(item)}>
                        <img
                          className="complany-logo-warp"
                          src={item?.image}
                          alt=""
              ...
              {Object.keys(FantasyGamesLibe).map((key, item) => (
                <div className="Inner_header_for_game_provide_Incasin">
                  <h3 className="provider_name_details">{key}</h3>

                  <div className="main_wrap_live-casion">
                    {FantasyGamesLibe &&
                      FantasyGamesLibe[key].map((item, index) => (
                        <div
                          className="MainBtn_warp"
                          style={{ border: "0.5px solid" }}
                          onClick={() => handleGamePageroute(item)}>
