  ...
  return (
    <>
      <div data-v-4732acba="" className="left-pane fdsfsdffs">
        {valueForGame === true ? (
          <SubSideBar
            valueForGame={valueForGame}
            sideGameData={sideGameData}
            sendData={sendData}
          />
        ) : (
            ...
            <nav data-v-4732acba="" className="tree-menu">
              <div data-v-4732acba="" className="left-menu-inner">
                <ul data-v-4732acba="" className="menu-column menu-lvl-0">
                  <Link
                    to={
                      localStorage.getItem("PassWordType") === "old"
                        ? "/changepassword"
                        : "/home"
                    }
                    ...
                    <img
                      ...
                      className="game-icon"
                    />
                    <span className="link-name"> In-Play</span>
                  </Link>
                    ...
                    ? postleftmenudataopenData?.data.map((item) => (
                        <li data-v-4732acba="">
                          <Link
                            ...
                            onClick={() =>
                              handleRoute(item?.sportId, item?.sportName)
                            }>
                            {item?.sportId === 77 ? (
                    ...
                    <>
                      <Link
                        to={
                          localStorage.getItem("PassWordType") === "old"
                            ? "/changepassword"
                            : "/m/International-home"
                        }
                        className="favourites-link download-apk">
                        <img
                          src="/Casino_Logo/international-casinoletest.png"
                          className="game-icon"
                          alt=""
                        />
                        <span className="link-name">International Casino</span>
                      </Link>
                      <Link
                        to={
                          localStorage.getItem("PassWordType") === "old"
                        ...
                        className="favourites-link download-apk">
                        <img
                          src="/Casino_Logo/lottery.png"
                          className="game-icon"
                          alt=""
                        />
                        <span className="link-name">Lottery </span>
                      </Link>
                      <Link
                        to={
                          localStorage.getItem("PassWordType") === "old"
                        ...
                        className="favourites-link download-apk">
                        <img
                          src="/Casino_Logo/slots.png"
                          className="game-icon"
                          alt=""
                        />
                        <span className="link-name">Slots Games</span>
                      </Link>
                      <Link
                        to={
                          localStorage.getItem("PassWordType") === "old"
                        ...
                        className="favourites-link download-apk">
                        <img
                          src="/Casino_Logo/fantasy-game.png"
                          className="game-icon"
                          alt=""
                        />
                        <span className="link-name">Fantasy Games</span>
                      </Link>
                    </>
                  ) : (
                    ""
