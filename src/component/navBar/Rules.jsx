...
const Rules = () => {
   return (
      <div><div id="rulesModal___BV_modal_body_" className="modal-body">
         <ul className="nav nav-tabs">
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Fancy</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Lunch Favourite</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Fancy Market 1</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Election</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Khado</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Big Bash League</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Caribbean premier league</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">IPL</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Bookmaker</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Football Fancy</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Betfair</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Kabaddi</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Football</Link ></li>
            <li className="nav-item"><Link data-toggle="tab" href="javascript:void(0)" className="nav-link">Tennis</Link ></li>
         </ul>
         <div className="tab-content">
            <div className="tab-pane active hands">
               <div className="table-responsive">
                  <table className="table table-bordered">
                     <tbody>
                        <tr>
                           <td>
                              <p className="m-b-0 text-danger" style={{ marginLeft: "1%" }}>
